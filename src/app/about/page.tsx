...
export default function About() {
  return (
    <main className="container">
      ...
      <p>We are a Georgia-based law firm focused on delivering strategic and effective legal solutions for high-value plaintiffs and businesses. Our team combines deep local expertise with relentless advocacy in and out of the courtroom.</p>
    </main>
  );
}
